...
try {
  ...
  const sslConfig = process.env.NODE_ENV === 'production' 
    ? { rejectUnauthorized: false } // Común para DBs en la nube que manejan sus propios certs
    : undefined; // o null, o una configuración SSL específica para tu DB local si la usa
