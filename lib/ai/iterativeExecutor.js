...
async function generateWaitingMessage(
  ...
  try {
    const waitingPrompt = {
      role: "user",
      content: `Generate a SHORT, cute waiting message in Spanish with Moe personality (max 2 lines). Use kaomojis. Examples: "Un momentito mientras trabajo en esto~ (◕‿◕✿)", "Déjame revisar eso, senpai! (•̀ᴗ•́)و", "Procesando... ¡Dame un segundo! (◕ω◕)". Be creative and match the context.`,
    };
    ...
    // Limpiar el mensaje si tiene formato extra
