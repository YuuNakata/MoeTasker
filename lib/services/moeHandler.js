...
export function getHelpMessage(senderName) {
    ...
    const escapedSenderName = bold(escapeHTML(senderName)); // Escapar y poner en negrita el nombre
  
    return (
      `¡Hola ${escapedSenderName}! Soy el bot de gestión de proyectos. ${escapeHTML(kaomoji)}\n\n` + // Escapar kaomoji
